...
static void
del(void *data, Evas_Object *obj, void *info)
{
   exit(0);
}
...
elm_main (int argc, char *argv[])
{
	...
	::elm_win win(elm_win_util_standard_add("efl-thread-3", "EFL Thread 3"));
...
win.autodel_set(true);
	...
	efl::evas::table table(efl::eo::parent = win);
	table.pack(o, 0, 0, 2, 1);
