...
// return elm_ctxpopup_item_append(&_ctxpopup_item_cb); // XXX
// }
...
// ::elm_ctxpopup ctxpopup(efl::eo::parent = win);
//    ctxpopup = obj.add();
//    ctxpopup.callback_dismissed_add(&_dismissed_cb);
//    ctxpopup.horizontal_set(true);
...
//    it.disabled_set(true);
//    item_new(ctxpopup, NULL, "clock");

//    evas_pointer_canvas_xy_get(evas_object_evas_get(obj), &x, &y);
//    evas_object_move(ctxpopup, x, y);
// ctxpopup.visibility_set(true);
...
//   	list.item_append("Ctxpopup with icons and labels", NULL, NULL,_list_item_cb, NULL); // XXX
// 	list.item_append("Ctxpopup with icons only", NULL, NULL,_list_item_cb2, NULL); 	// XXX
