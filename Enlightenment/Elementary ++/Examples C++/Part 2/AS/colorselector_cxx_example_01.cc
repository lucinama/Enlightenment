...
void _colorpalette_clicked_cb(::elm_colorselector data, Eo_Event_Description const& desc, void* info);
void _colorpalette_longpressed_cb(::elm_colorselector color_it, Eo_Event_Description const& desc, void* info);
...
void
_colorpalette_clicked_cb(::elm_colorselector data, Eo_Event_Description const& desc, void* info)
{
  int r = 0, g = 0, b = 0 ,a = 0;
...
void
_colorpalette_longpressed_cb(::elm_colorselector color_it, Eo_Event_Description const& desc, void* info)
{
  int r = 0,g = 0,b = 0 ,a = 0;
  Elm_Object_Item *color_it = (Elm_Object_Item *) info; // XXX
  color_it.palette_item_color_get(&r, &g, &b, &a);
