...
elm_main (int argc, char *argv[])
{
  ...
  //label1.text_set("elm.swallow.label" , "This is the CONTENT of our bubble");
  ...
  //bubble1.text_set("elm.text" , "LABEL");
  elm_object_text_set(bubble1._eo_ptr(), "LABEL");  
  //bubble1.content_set("elm.label", label1);
  ...
  //   bubble1.callback_clicked_add
  //   ([&win] (::elm_bubble& obj_ EINA_UNUSED, Eo_Event_Description const& desc EINA_UNUSED, void* info EINA_UNUSED)
  //    {
  //      ::elm_bubble obj(efl::eo::parent = win);
  //      static unsigned char corner = 0;
  //      ++corner;
  //      if (corner > 3)
  // 	 obj.pos_set(ELM_BUBBLE_POS_TOP_LEFT);
  ...
  // //label2.text_set("", "Bubble with no icon, info or label");
  ...
  // bubble2.content_set("elm.label", label2);
