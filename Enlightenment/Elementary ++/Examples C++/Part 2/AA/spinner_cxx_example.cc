...
static void
_changed_cb(::elm_spinner obj, Eo_Event_Description const& desc, void* info)
{
  std::cout << "Value changed to " << obj.value_get()<< std::endl;
}
...
elm_main (int argc, char *argv[])
{
  ...
  sp7.callback_changed_add(&_changed_cb);
  sp7.callback_delay_changed_add(&_delay_changed_cb);
